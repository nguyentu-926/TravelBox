    ...
    <div class="content-wrapper">
            ...
            <section class="destination-packages">
                ...
                <div class="destination-container">
                    <div class="destination-card">
                        <img src="images/a5.jpg" alt="Stockholm">
                        <h3>Stockholm</h3>
                        <p>Thụy Điển</p>
                        <p><strong>21tr200k</strong> / 3 ngày 2 đêm</p>
                    </div>
                    <div class="destination-card">
                        <img src="images/a3.jpg" alt="Paris">
                        <h3>Paris</h3>
                        <p>Pháp</p>
                        <p><strong>23tr400k</strong> / 3 ngày 2 đêm</p>
                    </div>
                </div>
            </section>
        </div>
        <div class="right-content">
            ...
            <div class="review-item">
                ...
                <div class="review-text">
                    <p><strong>Togame Jou:</strong> "Tôi sẽ còn quay lại."</p>
                </div>
            </div>
        </div>
    </div>
